                        ...
                        <div class="card-body">
                            ...
                            <form class="mt-5" action="{{route('register')}}" method="post">
                                ...
                                <div class="w-md-400px d-inline-flex row g-3 mb-4">
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" placeholder="First name" name="first_name" aria-label="First name" autofocus>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control" placeholder="Confirm Password" name="password_confirmation" aria-label="Confirm Password">
                                    </div>
